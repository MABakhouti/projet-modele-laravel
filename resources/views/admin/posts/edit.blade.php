                                ...
                                <form action="{{ url('admin/post/update') }}/{{ $post->id }}" method="POST"
                                    ...
                                    <div class="pl-lg-4 ">
                                        <div class="form-group ">
                                            ...
                                            <textarea name="post_content" rows="10" class="form-control " placeholder="Enter post title">{{ $post->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="pl-lg-4 ">
                                    ...
                                    <div class="d-flex mt-3 justify-content-end">
                                        ...
                                        <button type="submit" class="btn bg-gradient-success bg-success">Update Post</button>
                                    </div>
                                </form>
                            </div>
                        </div>
